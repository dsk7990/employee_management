                  ...
                  child: CButton(
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        _selectedDay = today.next(DateTime.monday);
                        _focusedDay = today.next(DateTime.monday);
                      });
                    },
                  ),
                ),
              ...
              children: [
                  ...
                  child: CButton(
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        isNextWeekSelected = false;
                        var today = DateTime.now();
                        _selectedDay = today.next(DateTime.tuesday);
                        _focusedDay = today.next(DateTime.tuesday);
                      });
                    },
                  ),
                ),
                ...
                Expanded(
                  child: CButton(
                    ...
                    textColor:
                        isNextWeekSelected ? Colors.white : AppColors.blueColor,
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        var today = DateTime.now();
                        _selectedDay = today.nextWeek(today.weekday);
                        _focusedDay = today.nextWeek(today.weekday);
                      });
                    },
                  ),
                ),
